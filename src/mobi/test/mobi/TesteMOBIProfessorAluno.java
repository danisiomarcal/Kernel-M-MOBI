...
//			rPessoaAluno.setContext(contextProfessorAluno);
			...
			Relation rSimetricaCasamento = mobi.createSymmetricRelation("ehCasado");
...
//			
			Relation rEquivalencia8 = mobi.createInheritanceRelation("merda");
			rEquivalencia8.setClassA(cPessoa);
			rEquivalencia8.setClassB(cMulher);
			rEquivalencia8.addInstanceRelation(iEduardo, iCamila);
			rEquivalencia8.processCardinality();
			mobi.addConcept(rEquivalencia8);
...
//			
			Relation rEquivalencia2 = mobi.createUnidirecionalCompositionRelationship("ensina");
			...
			Relation rEquivalencia3 = mobi.createUnidirecionalCompositionRelationship("ensina");
			rEquivalencia3.setClassA(cPessoa);
			rEquivalencia3.setClassB(cAluno);
			rEquivalencia3.addInstanceRelation(iCamila, iEduardo);
